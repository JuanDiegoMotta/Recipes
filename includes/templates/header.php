<header class="header">
    <div class="header__left flex-1">
        ...
        <div class="sub-menu flex justify-between flex-col z-40">
            <ul class="sub-menu__pages">
                ...
                <li>
                    <a href="<?php echo isset($_SESSION['user_id']) ? '/food-market' : '/login'; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000">
                ...
                <li>
                    <a href="<?php echo isset($_SESSION['user_id']) ? '/mykitchen' : '/login'; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000">
    ...
    <div class="header__right flex-1">
        ...
        <div class="shopping__cart-img-div relative">
