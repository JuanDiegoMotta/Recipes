  ...
  <div class="register">
    <div class="progress_bar">
      <div class="step current">
        <div class="icon_container">
          <svg class="icon_step" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368" id="icon_account">
      ...
      <svg class="separator" width="99" height="32" viewBox="0 0 99 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="step">
        <div class="icon_container">
          <svg class="icon_step" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368" id="icon_profile">
            <path d="M360-390q-21 0-35.5-14.5T310-440q0-21 14.5-35.5T360-490q21 0 35.5 14.5T410-440q0 21-14.5 35.5T360-390Zm240 0q-21 0-35.5-14.5T550-440q0-21 14.5-35.5T600-490q21 0 35.5 14.5T650-440q0 21-14.5 35.5T600-390ZM480-160q134 0 227-93t93-227q0-24-3-46.5T786-570q-21 5-42 7.5t-44 2.5q-91 0-172-39T390-708q-32 78-91.5 135.5T160-486v6q0 134 93 227t227 93Zm0 80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm-54-715q42 70 114 112.5T700-640q14 0 27-1.5t27-3.5q-42-70-114-112.5T480-800q-14 0-27 1.5t-27 3.5ZM177-581q51-29 89-75t57-103q-51 29-89 75t-57 103Zm249-214Zm-103 36Z" />
          </svg>
        </div>
        <div class="icon_text" id="icon_profile_text">Profile</div>
      </div>
      <svg class="separator" width="99" height="32" viewBox="0 0 99 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="1.5" cy="16" r="1.5" fill="#A1AEBE" />
        <circle cx="7.5" cy="16" r="1.5" fill="#A1AEBE" />
      ...
      <div class="step">
        <div class="icon_container">
          <svg class="icon_step" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368" id="icon_diet">
        ...
        <div class="icon_text" id="icon_diet_text">Diet</div>
      </div>
      <svg class="separator" width="99" height="32" viewBox="0 0 99 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="1.5" cy="16" r="1.5" fill="#A1AEBE" />
        <circle cx="7.5" cy="16" r="1.5" fill="#A1AEBE" />
      ...
      <div class="step">
        <div class="icon_container">
          <svg class="icon_step" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368" id="icon_calories">
        ...
        <div class="icon_text" id="icon_calories_text">Calories</div>
      </div>
    </div>
    <!-- ACCOUNT_FORM -->
      ...
      <form action="">
        <div class="form_section">
          <div class="input_block">
            ...
            <input type="email" name="email" id="email_account" />
          </div>
          <div class="input_block">
            <label for="username_account">Username</label>
            <input type="text" name="username" id="username_account" />
          </div>
        </div>
        <hr />
        <div class="form_section">
          <div class="input_block">
            ...
            <div class="password_wrapper" id="wrapper_password_account">
          ...
          <div class="input_block">
            <label for="confirm_password_account">Confirm password</label>
            <div class="password_wrapper" id="wrapper_confirm_password_account">
              <input type="password" id="confirm_password_account" name="confirm_password_account">
              <span class="material-symbols-outlined toggle-password" id="toggle-password-confirm">visibility</span>
            </div>
          </div>
        </div>
        <div class="button_container">
          <div class="next_button" id="next_button_account">
            <p>Next</p>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#ffffff">
              <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" />
            </svg>
          </div>
          <a href="/" class="skip_button">
            <p>Skip</p>
    ...
    <div class="form_container" id="profile_form">
      <form action="">
        ...
        <div class="button_container">
          <div class="next_button" id="next_button_profile">
            <p>Next</p>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#ffffff">
              <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" />
            </svg>
    ...
    <!-- FORM DIET-->
    <div class="form_container visible" id="diet_form">
      <form action="">
        <div class="form_section">
          ...
          <div class="input_block">
            <p id="allergy_title">Allergies</p>
        ...
        <hr />
        <div class="form_section">
          <div class="input_block radio_goal">
            <p>Goal</p>
        ...
        <div class="button_container">
          <div class="next_button" id="next_button_diet">
            <p>Next</p>
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#ffffff">
              <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" />
            </svg>
      ...
      <form action="" class="form_calories">
        <div class="form_sections">
          <div class="form_section" id="section_calculate_calories">
            <p class="section_title">Calculate your caloric intake:</p>
            <div class="input_block">
          ...
          <div class="form_section estimated_calories" id="section_estimated_calories">
            <p class="section_title">Estimated calories:</p>
            <div class="input_block">
              <label for="calories"></label>
              <input type="text" id="calories" name="calories" value="" readonly />
            </div>
          </div>
        </div>
        <div class="button_container">
          <a href="recipe-discovery" class="next_button" id="next_button_calories">
            <p>Finish</p>
